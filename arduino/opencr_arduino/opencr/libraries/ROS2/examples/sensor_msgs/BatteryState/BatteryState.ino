...
private:
  ...
  void timerCallback()
  {
    if(publisher_->isTimeToPublish())
    {
      ...
      battery_state_topic.header.stamp.sec = (int32_t)(nano_time_/(uint64_t)1000000000);
      battery_state_topic.header.stamp.nanosec = (uint32_t)(nano_time_%(uint64_t)1000000000);
