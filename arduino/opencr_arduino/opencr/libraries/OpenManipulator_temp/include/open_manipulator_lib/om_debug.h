...
void INFO(String msg, double num, String port = "USB", uint8_t point = 3);

void WARN(String msg, String port = "USB");
void WARN(String msg, double num, String port = "USB", uint8_t point = 3);

void ERROR(String msg, String port = "USB");
void ERROR(String msg, double num, String port = "USB", uint8_t point = 3);
} // namespace LOG
