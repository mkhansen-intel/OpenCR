...
void gripOnOff(OpenManipulator* manipulator, bool data)
{
  if(data)
    ...
    manipulator->toolMove(TOOL, 0.120f); // gripper close
}
// Move in Joint Space
...
bool pickStickMiddle(OpenManipulator* manipulator, int index)
{
  ...
  {
  case 0: gripOnOff(manipulator, true); moveJS(manipulator, 0.0, -1.05, 0.35, 0.6, 2.0);  break;
  case 1: /*OM 가운데 구멍 위치 (x, y, z, time)*/
    if(index == 0) moveCS(manipulator, -0.041, -0.000, 0.15, 1.5);     
    else if(index == 1) moveCS(manipulator, -0.045, -0.000, 0.15, 1.5); 
    break;
  case 2: // 집으러 내려가기
...
bool pickStickLeft(OpenManipulator* manipulator, int index)
{
  ...
  case 1: /*OM 왼쪽 구멍 위치 (x, y, z, time)*/
    if(index == 0) moveCS(manipulator, -0.040, -0.072, 0.15, 1.5); 
    else if(index == 1) moveCS(manipulator, -0.040, -0.072, 0.15, 1.5); 
    break;
  case 2: // 집으러 내려가기
    if(index == 0) manipulator->drawLine(TOOL, OM_MATH::makeVector3(0.0, 0.0, -0.058f), 1.0f);      
...
bool placeStickMiddle(OpenManipulator* manipulator, int index, int opt)
{
  ...
  case 4: manipulator->drawLine(TOOL, OM_MATH::makeVector3(0.0, 0.0, 0.100f), 0.6f); return 1; 
  }
  return 0;
}
...
bool motion4(OpenManipulator* manipulator, int index)
{
  ...
  case 5: drawObj(manipulator, 2.0, BOTTLESHAKE, 0.030, 0.0); return 1; 
  }
  return 0;
}
...
bool motion5_2(OpenManipulator* manipulator, int index)
{
  ...
  case 2: drawObj(manipulator, 1.5, BOTTLESHAKEX, 0.020, 0.0); return 1; 
  }
  return 0;
}
bool motion5_1(OpenManipulator* manipulator, int index)
{
  ...
  case 0: moveJS(manipulator,  0.0, -1.33, 0.38, 0.87, 1.5); break;
  case 1: drawObj(manipulator, 1.5, BOTTLESHAKEY, 0.020, 0.0); return 1; 
  }
  return 0;
}
...
bool motion6(OpenManipulator* manipulator, int index)
{
  ...
  {
  case 0: moveJS(manipulator,  0.0, -0.86, 0.33, 0.53, 2.0); break;
  case 1: drawObj(manipulator, 1.5, BOTTLESHAKE3, 0.020, 0.0); return 1; 
  }
  return 0;
}
