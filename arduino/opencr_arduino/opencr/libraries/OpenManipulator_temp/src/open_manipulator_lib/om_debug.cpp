...
#include "../../include/open_manipulator_lib/om_debug.h"
...
void LOG::INFO(String msg, double num, String port, uint8_t point)
{
  if (port == "USB")
  {
    USB.print("[INFO] ");
...
void LOG::WARN(String msg, double num, String port, uint8_t point)
{
  if (port == "USB")
  {
    USB.print("[WARN] ");
...
void LOG::ERROR(String msg, double num, String port, uint8_t point)
{
  if (port == "USB")
  {
    USB.print("[ERROR] ");
