...
void Planar::initManipulator(bool using_platform, STRING usb_port, STRING baud_rate)
{
...
//  STRING inverse_option = "sr_inverse";
  ...
  {
    ////////// joint actuator init.
    actuator_ = new PLANAR_DYNAMIXEL::JointDynamixel();
...
void Planar::Process(double present_time)
{
