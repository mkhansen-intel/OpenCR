...
void setup()
{
  ...
  linear.addDraw(HEART, heart);
  linear.addDraw(SPIRAL, spiral);
  linear.addDraw(SPIRAL2, spiral2);
...
void loop()
{
  ...
  {    
    linear.setPresentTime((float)(millis()/1000.0f));
    linear.jointControl();
    linear.jointControlForDrawing(TOOL);    
