...
void Delta::forward(Manipulator *manipulator)
{
  // forward(manipulator, manipulator->getWorldChildName());
}

void Delta::forward(Manipulator *manipulator, Name component_name)
{
...
std::vector<double> Delta::inverse(Manipulator *manipulator, Name tool_name, Pose target_pose)
{
  geometricInverseKinematics(manipulator, tool_name, target_pose);
}

std::vector<double> Delta::geometricInverseKinematics(Manipulator *manipulator, Name tool_name, Pose target_pose)
{
