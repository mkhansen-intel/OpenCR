...
void Linear::initManipulator(bool using_platform, STRING usb_port, STRING baud_rate)
{
...
//  STRING inverse_option = "sr_inverse";
  ...
  {
    ////////// joint actuator init.
    actuator_ = new LINEAR_DYNAMIXEL::JointDynamixel();
    ...
    ////////// tool actuator init.
    tool_ = new LINEAR_DYNAMIXEL::GripperDynamixel();
...
void Linear::process(double present_time)
{
