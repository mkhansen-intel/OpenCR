...
void Stewart::initManipulator(bool using_platform, STRING usb_port, STRING baud_rate)
{
...
//  STRING inverse_option = "sr_inverse";
  ...
  {
    ////////// joint actuator init.
    actuator_ = new STEWART_DYNAMIXEL::JointDynamixel();
    ...
    ////////// tool actuator init.
    tool_ = new STEWART_DYNAMIXEL::GripperDynamixel();
...
void Stewart::process(double present_time)
{
