...
#define MR_CONFIG_MIN_SESSION_CONNECTION_INTERVAL    100
#define MR_CONFIG_MIN_HEARTBEAT_TIME_INTERVAL        100

#define MR_CONFIG_UDP_TRANSPORT_MTU                  0
#define MR_CONFIG_TCP_TRANSPORT_MTU                  0
